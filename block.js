  ...
  function Game() {
    ...
    document.addEventListener("click", function (e) {
      if (_this.state === _this.STATES.READY && e.target.id === "sbtn") {
        ...
        document.querySelector(".nPopup").style.display !== "block" &&
  ...
  Game.prototype.restartGame = function () {
    ...
    var _loop_1 = function (i) {
      TweenLite.to(oldBlocks[i].scale, removeSpeed, {
        ...
        y: 0,
        z: 0,
        delay: (oldBlocks.length - 1) * delayAmount,
        ease: Power1.easeIn,
        onComplete: function () {
    ...
    TweenLite.to(countdown, cameraMoveSpeed, {
      value: 0,
      onUpdate: function () {
        _this.scoreContainer.innerHTML = "Score: " + String(Math.round(countdown.value));
      },
    });
    TweenLite.to(countdown, cameraMoveSpeed, {
      value: 0,
      onUpdate: function () {
        _this.bestScoreContainer.innerHTML = "Best Score: " + String(Math.round(countdown.value));
      },
    });
